...
.field private static final FAKESCREEN_TYPE_1:I = 0x1

.field private static final FAKESCREEN_TYPE_2:I = 0x2

.field private static final FAKESCREEN_TYPE_3:I = 0x3

.field private static final FAKESCREEN_TYPE_4:I = 0x4

.field private static final FAKESCREEN_TYPE_5:I = 0x5
...
.field private final mFractionOptionMenuHeight:F
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mFractionOptionMenuHeight:F
...
.method private getDrawableResIdentifier(Ljava/lang/String;I)I
    ...
    const-string v5, "No such resource was found with the given name="
...
.method private openPanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    .end local v16           #isHoneycombApp:Z
    .end local v17           #isXLarge:Z
    :cond_2
    ...
    invoke-virtual {v4, v0}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v4, v0, v15}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->measure(II)V
    ...
    invoke-virtual {v4}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->getMeasuredHeight()I
...
.method private printViewTree(Landroid/view/ViewGroup;I)V
    ...
    const-string v5, ", isRootNamespace: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    invoke-virtual {p1}, Landroid/view/ViewGroup;->isRootNamespace()Z
...
.method protected generateLayout(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, v1, v13}, Lcom/android/internal/policy/impl/PhoneWindow;->setFlags(II)V
    ...
    iget-boolean v0, v0, Landroid/content/pm/ApplicationInfo;->allowSkinChange:Z
    ...
    sget-object v25, Lcom/htc/R$styleable;->HtcFakescreen:[I
    ...
    .line 2732
    .end local v5           #attr:Landroid/content/res/TypedArray;
    :cond_e
    move-object/from16 v0, p0
    ...
    iput v6, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mBackgroundResource:I

    .line 2754
    .end local v6           #backgroundResId:I
    .end local v7           #bg:I
    .end local v10           #disableFake:Z
    :cond_10
    :goto_7
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->startChanging()V
    ...
    const-string v26, "layoutResource: "
    ...
    const-string v26, ", ID_ANDROID_CONTENT: "
    ...
    const-string v25, "LayoutInflater.inflate() = null"
    ...
    .line 2735
    .restart local v6       #backgroundResId:I
    .restart local v7       #bg:I
    .restart local v10       #disableFake:Z
    ...
    .line 2737
    :pswitch_0
    const-string v24, "prefetch_screen_type_01"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindow;->getDrawableResIdentifier(Ljava/lang/String;I)I
    ...
    .line 2740
    :pswitch_1
    const-string v24, "prefetch_screen_type_02"
    ...
    .line 2743
    :pswitch_2
    const-string v24, "prefetch_screen_type_03"
    ...
    .line 2746
    :pswitch_3
    const-string v24, "prefetch_screen_type_04"
    ...
    .restart local v14       #in:Landroid/view/View;
    :cond_25
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/internal/policy/impl/PhoneWindow;->printViewTree(Landroid/view/ViewGroup;I)V
    ...
    const-string v26, "LayoutInflater.inflate() = "
    ...
    iget-object v11, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setWindowBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->finishChanging()V
...
.method public setContentView(I)V
    ...
    const-string v3, "setContentView, res: "
    ...
    const-string v3, ", mContentParent: "
    ...
    const-string v3, "setContentView, mLayoutInflater: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLayoutInflater:Landroid/view/LayoutInflater;
